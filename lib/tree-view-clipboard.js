...
export default {
    ...
    paths: function(bool) {
        ...
        return selected.map((item) => item.querySelector('.name').dataset.path);
    },
    ...
    copy(e) {
        ...
        var command = copyPath+'\\copy.cmd '+copyPath+'\\copy';
        ...
        childProcess.exec(command, (err, stdout, stderr) => {
            ...
            else console.log(stdout, stderr, '\nFinished copying folder/file(s)!');
        });
    },
    ...
    cut(e) {
        ...
        var command = cutPath+'\\cut.cmd '+cutPath+'\\cut';
        ...
        childProcess.exec(command, (err, stdout, stderr) => {
            if (err) console.log(err);
            else console.log(stdout, stderr, '\nFinished cutting folder/file(s)!');
        });
    },
    ...
    paste(e) {
        ...
        var command = pastePath+'\\paste.cmd '+pastePath+'\\paste';

        this.paths(true).forEach((path) => {
            command += ' '+path;
        });

        childProcess.exec(command, (err, stdout, stderr) => {
            if (err) console.log(err);
            else console.log(stdout, stderr, '\nFinished pasting folder/file(s)!');
        });
    }
